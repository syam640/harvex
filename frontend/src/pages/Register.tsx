    ...
    <div className="min-h-screen bg-agricultural-gradient flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-charcoal-500 mt-2">Start Your Smart Farming Journey</p>
        </div>
        ...
        <div className="card animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="label">{t('name') || 'Full Name'}</label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-primary btn-pill text-lg py-4 flex items-center justify-center gap-2 mt-6"
            >
              {loading ? (
                <>
